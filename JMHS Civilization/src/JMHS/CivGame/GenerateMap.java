	...
	public static float[][] GenerateSmoothNoise(float[][] baseNoise, int octave) {
		...
		for (int i = 0; i < width; i++) {
			...
			for (int j = 0; j < height; j++) {
				...
				float top = lerp(baseNoise[sample_i0][sample_j0], baseNoise[sample_i1][sample_j0], horizontal_blend);

				// blend the bottom two corners
				float bottom = lerp(baseNoise[sample_i0][sample_j1], baseNoise[sample_i1][sample_j1], horizontal_blend);
